...
const RECIPES = [
  ...
  // Tiered recipes — these take already-crafted compounds as ingredients instead of (or in
  // addition to) raw elements, so drag a compound you made earlier back into a reactor to
  // work up to these.
  { formula:'H2CO3', name:'Carbonic Acid', need:{}, needCompounds:{H2O:1,CO2:1}, tool:'electrolysis', desc:'Forms when carbon dioxide dissolves in water — also what makes soda fizzy.' },
  { formula:'NaHCO3', name:'Sodium Bicarbonate (Baking Soda)', need:{}, needCompounds:{NaOH:1,CO2:1}, tool:'pressure', desc:'Made by reacting sodium hydroxide with carbon dioxide — better known as baking soda.' },
  { formula:'CuCO3', name:'Copper Carbonate (Patina)', need:{}, needCompounds:{CuO:1,CO2:1}, tool:'pressure', desc:'The green patina seen on old copper roofs and statues, like the Statue of Liberty.' },
  { formula:'Al(OH)3', name:'Aluminium Hydroxide', need:{H:2}, needCompounds:{Al2O3:1,H2O:1}, tool:'pressure', desc:'Formed from aluminium oxide and water — used in antacids and water treatment.' },
];
